    ...
    <AppLayout>
        <div class="max-w-lg mx-auto px-4 py-8">
            <div class="flex items-center gap-3 mb-6">
                <Link href="/mon-truck" class="text-warm-500 hover:text-warm-900 text-sm">← Mes trucks</Link>
                <span class="text-warm-200">·</span>
                <h1 class="text-xl font-medium text-warm-900">Modifier {{ truck.name }}</h1>
            </div>

            <form class="space-y-8" @submit.prevent="submit">
                <!-- Section 1 -->
                <div>
                    <h2 class="text-xs font-medium text-warm-500 uppercase tracking-wide mb-4">Informations</h2>
                    <div class="bg-white border border-warm-200 rounded-xl p-5">
                        <Step1Info :form="form" :cuisines="page.props.cuisines" />
                    </div>
                </div>

                <!-- Section 2 -->
                <div>
                    <h2 class="text-xs font-medium text-warm-500 uppercase tracking-wide mb-4">Emplacement</h2>
                    <div class="bg-white border border-warm-200 rounded-xl p-5">
                ...
                <!-- Section 3 -->
                <div>
                    <h2 class="text-xs font-medium text-warm-500 uppercase tracking-wide mb-4">Horaires</h2>
                    <div class="bg-white border border-warm-200 rounded-xl p-5">
                ...
                <div v-if="Object.keys(form.errors).length > 0" class="text-xs text-red-500 text-center">
